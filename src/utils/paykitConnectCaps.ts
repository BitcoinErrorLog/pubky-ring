 ...
 * https path and on combined `hypercolor://` (secret+relay required)
 * before the confirmation sheet so a QR cannot impersonate Hypercolor
 * with `/:rw` (P2-1). Other custom-scheme callbacks stay unbounded.
 */
